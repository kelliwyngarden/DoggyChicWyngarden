...
public class StartAppointment {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("Please provide more information for your appointment on " + dateFormat.format(date) + " at " + timeFormat.format(start) + "--");
		...
		/**InStoreAppointment apptA = new InStoreAppointment(custA, petA, servicesA, date, start);
		MobileAppointment apptB = new MobileAppointment(custA, petA, servicesA, date, start);

		System.out.print("Please enter i for in-store appointment or m for mobile appointment: ");
		String input = in.nextLine();
		while (!(input.equals("i")) && !(input.equals("m"))) {
			System.out.print("Invalid input. Please enter either i or m: ");
			in.nextLine();
		}
		System.out.println();
		if (input.equals("i")) {
	...
	public static Customer getCustomerInfo() {
		...
		Customer cust = new Customer(firstName, lastName, phoneNumber, address, city, state, zip);
