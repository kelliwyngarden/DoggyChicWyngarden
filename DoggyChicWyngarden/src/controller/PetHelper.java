...
public class PetHelper {
	EntityManagerFactory emfactory = Persistence.createEntityManagerFactory("DoggyChicWyngarden");
	...
	public List<Pet> showAllPets() {
		// TODO Auto-generated method stub
		EntityManager em = emfactory.createEntityManager();
		TypedQuery<Pet> allResults = em.createQuery("select p from Pet p", Pet.class);
